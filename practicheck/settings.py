...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,127.0.0.1,asingojnr.pythonanywhere.com, 35.154.122.27, ec2-35-154-122-27.ap-south-1.compute.amazonaws.com,0.0.0.0', cast=lambda v: [s.strip() for s in v.split(',')])
